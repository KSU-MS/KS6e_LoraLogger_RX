...
def main():
    ...
    numPlots = 10            # number of plots in 1 graph
    ...
    lineLabel = ['Accel 1', 'Accel 2', 'Brake','Motor Temp','Motor RPM','Pack Voltage','Torque Cmd','Inverter Temp','Inverter Current','Inverter Faults']
    style = ['r-', 'c-', 'b-','g-','y-','k-','m-','C0-','C9-','C1-']  # linestyles for the different plots
